"""Shared test fixtures for market-research-agent-svc."""
...
def valid_execute_payload() -> dict[str, Any]:
    ...
    """
    return {
        "input_prompt": "What is the market size for AI-powered brand tools?",
        ...
        "config": {"focus": "market_analysis,sizing,trends"},
        "previous_outputs": {},
    }
