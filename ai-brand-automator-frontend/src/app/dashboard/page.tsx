  ...
  return (
    <div className="min-h-screen bg-brand-midnight">
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h1 className="font-heading text-3xl font-heading font-bold text-white mb-8">Dashboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6">
              <h2 className="font-heading text-xl font-heading font-semibold text-white mb-4">Social Media Analytics</h2>
              <SocialAnalytics />
            </div>
