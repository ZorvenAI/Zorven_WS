...
function normalizeCampaign(
  ...
  return {
    ...
    actual_cpa_usd: c.actual_cpa_usd ?? null,
    actual_roas: c.actual_roas ?? null,
    actual_ctr: c.actual_ctr ?? null,
    actual_spend_today_usd: c.actual_spend_today_usd ?? null,
    last_metrics_update: c.last_metrics_update ?? null,
