...
export default function SocialAnalytics() {
  ...
  if (!hasConnectedPlatforms) {
    return (
      <div className="glass-card p-6">
        <h2 className="font-heading text-xl font-heading font-bold text-white mb-4">Social Analytics</h2>
      ...
      {profiles?.twitter?.connected && (
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading text-xl font-heading font-bold text-white flex items-center gap-2">
