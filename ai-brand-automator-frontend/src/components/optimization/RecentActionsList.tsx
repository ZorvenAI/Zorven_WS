  ...
  return (
    <div className="glass-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <Tooltip tabIndex={0} text="Log of optimization actions executed on this campaign. Includes both autonomous (auto-applied) and manual (human-approved) actions. Shows the most recent 20 actions.">
            ...
            <thead>
              <tr className="text-brand-silver/60 border-b border-white/5">
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="When the action was executed.">
                    <span className="cursor-default">Date</span>
                  </Tooltip>
                </th>
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="The campaign this action was applied to.">
                    <span className="cursor-default">Campaign</span>
                  </Tooltip>
                </th>
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="The type of optimization action taken (e.g., Pause, Scale, Reallocate, Adjust Bid).">
                    <span className="cursor-default">Action</span>
                  </Tooltip>
                </th>
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="The specific entity (campaign, ad set, or ad) the action was applied to.">
                    <span className="cursor-default">Entity</span>
                  </Tooltip>
                </th>
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="How the action was applied. Autonomous means auto-applied by the AI; Manual means a human approved it first.">
                    <span className="cursor-default">Mode</span>
                  </Tooltip>
                </th>
                <th className="text-center py-2 font-medium">
                  <Tooltip tabIndex={0} text="Whether the action was verified as successfully applied on Meta Ads after execution.">
                    <span className="cursor-default">Verified</span>
                  </Tooltip>
                </th>
                <th className="text-left py-2 font-medium">
                  <Tooltip tabIndex={0} text="The AI-generated explanation for why this action was recommended and executed.">
