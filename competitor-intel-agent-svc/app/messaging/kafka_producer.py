"""
Kafka producers for competitor-intel-agent-svc.

TraceProducer  - emits step updates to agent-trace-topic
AuditProducer  - emits audit events to competitor-intel-audit-topic
...
class TraceProducer:
    ...
    async def send_step(
        ...
        node_id: str = "competitor_intelligence_worker",
...
class AuditProducer:
    """Emits audit events to competitor-intel-audit-topic for compliance."""

    TOPIC = "competitor-intel-audit-topic"
    ...
    async def send_audit(
        ...
        """
        Emit an audit event with analysis metadata.
