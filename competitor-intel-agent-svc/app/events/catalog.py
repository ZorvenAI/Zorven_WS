"""Event catalog - EVT-001 through EVT-016 per design document.

All events are emitted to Kafka audit topic (when available) and structured logger.
Extended from MRA's 14 events with EVT-015 (registry.updated) and EVT-016 (change.detected).
"""
...
class EventCatalog:
    ...
    REGISTRY_UPDATED = "EVT-015"
    CHANGE_DETECTED = "EVT-016"
    ...
    DESCRIPTIONS: dict[str, str] = {
        ...
        "EVT-015": "competitor.registry.updated",
        "EVT-016": "competitor.change.detected",
    }
