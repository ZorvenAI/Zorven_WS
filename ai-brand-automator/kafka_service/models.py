...
class AuditLog(models.Model):
    ...
    consumer = models.CharField(
        max_length=255, null=True, blank=True, help_text="Kong consumer username"
    )
    service = models.CharField(
        max_length=255, null=True, blank=True, help_text="Kong service name"
    )
    route = models.CharField(
        max_length=255, null=True, blank=True, help_text="Kong route name"
    )
