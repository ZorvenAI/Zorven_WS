...
class BrandNarrativeSynthesizer:
    ...
    def build_system_prompt(self) -> str:
        ...
        return (
            ...
            "investor, press. Each has: channel, content, tone, word_count. "
            "Include 'channel_consistency_score' (0-1).\n"
            "2. story_style_guide: Object with narrative_principles (array), "
            "approved_themes (array), forbidden_themes (array), "
            "tone_guidelines (object), example_passages (array), "
            "do_say (array), dont_say (array).\n"
            "3. subbrand_stories: Array of objects with brand_context_id, "
            "brand_name, origin_story_short, positioning_hook, "
